      ...
      <div className="hidden sm:flex sm:flex-row sm:gap-x-2">
        ...
        <Link href="https://www.linkedin.com/in/grahamreveritt/" passHref>
          <a
            ...
            aria-label="linkedin"
            className="rounded-lg border-2 border-cyan-900 bg-zinc-cyan p-2 text-2xl text-white hover:border-white"
          >
            <AiOutlineLinkedin />
          </a>
        </Link>
        ...
        <Link href="https://github.com/grahamcodes" passHref>
          <a
            className="rounded-lg border-2 border-cyan-900 bg-cyan-800 p-2 text-2xl text-white hover:border-white"
            target="_blank"
            rel="noopener noreferrer"
